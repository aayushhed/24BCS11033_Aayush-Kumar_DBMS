...
### Problem 2
List **all customer names** and their corresponding **product_name** from the `orders` table, if they have any. Include customers even if they haven't placed any orders.

---

### Problem 3
Display the **product_name** and **order_date** for all products that have been ordered.